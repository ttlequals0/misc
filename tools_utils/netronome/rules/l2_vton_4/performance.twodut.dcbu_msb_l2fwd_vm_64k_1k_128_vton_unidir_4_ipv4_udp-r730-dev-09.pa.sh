...
# Test: performance.twodut.dcbu_msb_l2fwd_vm_64k_1k_128_vton_unidir_4_ipv4_udp
# DUT : r730-dev-09.pa
...
screen -dmS monitors
screen -ls
screen -S 106145.monitors -X stuff '/tmp/sdn-test/monitor performance.twodut.dcbu_msb_l2fwd_vm_64k_1k_128_vton_unidir_4_ipv4_udp_r730-dev-09.pa_beagle_rev3290_100_throughput /tmp/sdn-test/logs/monitor-logs_r730-dev-09.pa testbr0 3600 S,A sdn_p0 sdn_v0.0 sdn_v0.1 sdn_v0.2 sdn_v0.3\n'
pgrep monitor
/bin/kill -SIGTERM 104390
/bin/kill -SIGTERM 104679
/bin/kill -SIGTERM 106166
/bin/kill -SIGTERM 107542
/bin/kill -SIGTERM 107543
/bin/kill -SIGTERM 107544
/bin/kill -SIGTERM 107545
/bin/kill -SIGTERM 107546
/bin/kill -SIGTERM 107549
cd /tmp/sdn-test && tar cfz /tmp/sdn-test/performance.twodut.dcbu_msb_l2fwd_vm_64k_1k_128_vton_unidir_4_ipv4_udp_r730-dev-09.pa_beagle_rev3290_logs.tar.gz logs
