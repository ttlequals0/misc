...
# Test: performance.twodut.dcbu_msb_l2fwd_ix_64k_1k_128_ntov_unidir_4_10_ipv4_udp
# DUT : r730-dev-09.pa
...
screen -dmS monitors
screen -ls
screen -S 71824.monitors -X stuff '/tmp/sdn-test/monitor performance.twodut.dcbu_msb_l2fwd_ix_64k_1k_128_ntov_unidir_4_10_ipv4_udp_r730-dev-09.pa_beagle_rev3290_100_throughput /tmp/sdn-test/logs/monitor-logs_r730-dev-09.pa testbr0 3600 S,A sdn_p0 sdn_v0.0 sdn_v0.1 sdn_v0.2 sdn_v0.3\n'
pgrep monitor
/bin/kill -SIGTERM 70077
/bin/kill -SIGTERM 70368
/bin/kill -SIGTERM 71845
/bin/kill -SIGTERM 73222
/bin/kill -SIGTERM 73223
/bin/kill -SIGTERM 73224
/bin/kill -SIGTERM 73225
/bin/kill -SIGTERM 73226
/bin/kill -SIGTERM 73228
cd /tmp/sdn-test && tar cfz /tmp/sdn-test/performance.twodut.dcbu_msb_l2fwd_ix_64k_1k_128_ntov_unidir_4_10_ipv4_udp_r730-dev-09.pa_beagle_rev3290_logs.tar.gz logs
