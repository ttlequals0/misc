...
# Test: performance.twodut.dcbu_msb_l3fwd_vm_64k_1k_128_vtov_bidir_4_ipv4_udp
# DUT : r730-dev-09.pa
...
screen -dmS monitors
screen -ls
screen -S 12300.monitors -X stuff '/tmp/sdn-test/monitor performance.twodut.dcbu_msb_l3fwd_vm_64k_1k_128_vtov_bidir_4_ipv4_udp_r730-dev-09.pa_beagle_rev3290_100_throughput /tmp/sdn-test/logs/monitor-logs_r730-dev-09.pa testbr0 3600 S,A sdn_v0.0 sdn_v0.1 sdn_v0.2 sdn_v0.3\n'
pgrep monitor
/bin/kill -SIGTERM 10578
/bin/kill -SIGTERM 10871
/bin/kill -SIGTERM 12321
/bin/kill -SIGTERM 13441
/bin/kill -SIGTERM 13442
/bin/kill -SIGTERM 13443
/bin/kill -SIGTERM 13444
/bin/kill -SIGTERM 13446
cd /tmp/sdn-test && tar cfz /tmp/sdn-test/performance.twodut.dcbu_msb_l3fwd_vm_64k_1k_128_vtov_bidir_4_ipv4_udp_r730-dev-09.pa_beagle_rev3290_logs.tar.gz logs
