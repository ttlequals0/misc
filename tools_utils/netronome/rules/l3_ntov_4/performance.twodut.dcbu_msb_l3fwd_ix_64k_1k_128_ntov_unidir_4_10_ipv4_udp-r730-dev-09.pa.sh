...
# Test: performance.twodut.dcbu_msb_l3fwd_ix_64k_1k_128_ntov_unidir_4_10_ipv4_udp
# DUT : r730-dev-09.pa
...
ovs-ofctl -OOpenFlow13 show testbr0
ovs-ofctl -OOpenFlow13 del-flows testbr0
ovs-ofctl -OOpenFlow13 add-flows testbr0 /tmp/sdn-test/r730-dev-09.pa_l3fwd_msb.flows
screen -ls
screen -dmS monitors
screen -ls
screen -S 89015.monitors -X stuff '/tmp/sdn-test/monitor performance.twodut.dcbu_msb_l3fwd_ix_64k_1k_128_ntov_unidir_4_10_ipv4_udp_r730-dev-09.pa_beagle_rev3290_100_throughput /tmp/sdn-test/logs/monitor-logs_r730-dev-09.pa testbr0 3600 S,A sdn_p0 sdn_v0.0 sdn_v0.1 sdn_v0.2 sdn_v0.3\n'
pgrep monitor
/bin/kill -SIGTERM 87236
/bin/kill -SIGTERM 87529
/bin/kill -SIGTERM 89036
/bin/kill -SIGTERM 90412
/bin/kill -SIGTERM 90413
/bin/kill -SIGTERM 90414
/bin/kill -SIGTERM 90415
/bin/kill -SIGTERM 90416
/bin/kill -SIGTERM 90418
cd /tmp/sdn-test && tar cfz /tmp/sdn-test/performance.twodut.dcbu_msb_l3fwd_ix_64k_1k_128_ntov_unidir_4_10_ipv4_udp_r730-dev-09.pa_beagle_rev3290_logs.tar.gz logs
